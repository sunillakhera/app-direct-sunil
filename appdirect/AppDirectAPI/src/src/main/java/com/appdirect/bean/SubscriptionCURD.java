...
public class SubscriptionCURD {
 ...
 @JsonCreator
 public SubscriptionCURD(@JsonProperty("subscriptionId") Long subscriptionId, @JsonProperty("unit") String unit,
